...
正規化結果は`modules/minutes_db/`のSQLite/FTS5へ入り、検索結果から
...
沿って自作する想定です。手順は
[未対応ベンダーに出会ったら](../../modules/minutes_db/adapter_guidance.md)を
参照してください。
...
`modules/minutes_db/`にはkaigiroku.netアダプター、静的HTML/PDFアダプター、
